...
public class VistaModificarDisco extends JFrame implements GUI{
	...
	private static final long serialVersionUID = 1L;
		...
		protected void setCommonGUI()
		{
	            ...
	            public void actionPerformed(java.awt.event.ActionEvent evt) {
	            	...
	            	if (id.getText()!=null){
	            		try{
	            			...
	            			Integer añoaux=null,stockaux=null,gramajeaux=null,revolucionesaux=null;
	    	            	Float precioaux= null;
	    	            	Boolean dvdaux=null;
	    	            	if(!año.getText().isEmpty())añoaux=Integer.parseInt(año.getText());
	            			...
	            			if(eleccion == 0){
	            				...
	            				Presentación.ApplicationController.ApplicationController.getInstance().action(new Contexto(Evento.MODIFICAR_DISCO_OK, new TDiscoCD(Integer.parseInt(id.getText()), nombre.getText(), añoaux, precioaux, stockaux, genero.getText(), true, dvdaux)));
	            				}
	            			else{
	            				...
	            				Presentación.ApplicationController.ApplicationController.getInstance().action(new Contexto(Evento.MODIFICAR_DISCO_OK, new TDiscoVinilo(Integer.parseInt(id.getText()), nombre.getText(), añoaux, precioaux, stockaux, genero.getText(), true, revolucionesaux, gramajeaux, prensado.getText())));
	            			}
            			} catch(Exception ex){
	        ...
	        textaño.setBounds(60, 380, 210, 70);
