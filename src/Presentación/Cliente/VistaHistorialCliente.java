...
//solo falta la tabla donde se muestra el historial
...
public class VistaHistorialCliente extends JFrame implements GUI{
	    ...
	    private void initGUI() {
	            ...
	            public void actionPerformed(ActionEvent evt) {
	            	if (id.getText()!= null){
	            		try{
	            			...
	            			ApplicationController.getInstance().action(new Contexto(Evento.MOSTRAR_HISTORIAL_COMPRA_OK, Integer.parseInt(id.getText())));
	        ...
	        textid.setText("Mostrar historial del cliente con id:");
		...
		public void update(Contexto contexto) {
			if(contexto.getDato() != null)
			{
				...
				discos = (ArrayList<TDisco>)contexto.getDato();
				String stringDiscos = "";
	    		if (discos != null){
			...
			else if(contexto.getEvento() == Evento.MOSTRAR_HISTORIAL_COMPRA_OK){
				dispose();
