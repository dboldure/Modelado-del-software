...
public class VistaBajaEmpleado extends JFrame implements GUI {
	...
	private void initGUI(){
       ...
       confirmar.addActionListener(new ActionListener() {
           public void actionPerformed(ActionEvent evt) {
           	if (id.getText() != null){
           		try{
           			ApplicationController.getInstance().action(new Contexto(Evento.BAJA_EMPLEADO_OK, Integer.parseInt(id.getText())));
       ...
       textid.setText("Dar de baja al empleado con id:");
		...
		if (contexto.getDato() != null){
			...
			switch((int)contexto.getDato()){
				case -1: JOptionPane.showMessageDialog(new JFrame(),"Error sintactico", "Error", JOptionPane.ERROR_MESSAGE);
					break;
				case -2: JOptionPane.showMessageDialog(new JFrame(),"El empleado a dar de baja no existe", "Error", JOptionPane.ERROR_MESSAGE);
					break;
				case -3: JOptionPane.showMessageDialog(new JFrame(),"El empleado a dar de baja ya ha sido eliminado", "Error", JOptionPane.ERROR_MESSAGE);
					break;
				case -100: JOptionPane.showMessageDialog(new JFrame(),"Error en la gestion de la Base de Datos", "Error", JOptionPane.ERROR_MESSAGE);
					break;
				default:
					JOptionPane.showMessageDialog(new JFrame(), "Se dio de baja correctamente el empleado con id: " + id);
					break;
			}
		}
