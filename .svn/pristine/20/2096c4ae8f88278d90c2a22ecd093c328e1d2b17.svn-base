...
public class VistaNominaDepartamento extends JFrame implements GUI{
	...
	public VistaNominaDepartamento(){
		super();
		initGUI();
	}
		...
		private void initGUI() {
		    ...
		    setTitle("Calcular nomina departamento");
		        ...
		        public void actionPerformed(java.awt.event.ActionEvent evt) {
		        	if (id.getText()!= null){
		        		try{
		        			...
		        			ApplicationController.getInstance().action(new Contexto(Evento.NOMINA_DEPARTAMENTO_OK, Integer.parseInt(id.getText())));
		    ...
		    textid.setText("Mostar nomina del departamento con id:");
	...
	public void update(Contexto cont) {
		if(cont.getDato() != null){
			...
			JFrame ventana = new JFrame("Mostar nomina");
